...
df = pd.read_csv(train_path + 'training_20min_avg_travel_time.csv', header = 0, error_bad_lines=False)
...
df.to_csv(train_path + 'training_20min_avg_travel_time_filled.csv', index = False)